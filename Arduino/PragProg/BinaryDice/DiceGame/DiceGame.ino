...
const unsigned int LED_BIT3 =  2;
const unsigned int LED_BIT4 =  3;
const unsigned int LED_BIT5 =  4;
...
void output_guess(const long result) {
  digitalWrite(LED_BIT3, result & B001);
  digitalWrite(LED_BIT4, result & B010);
  digitalWrite(LED_BIT5, result & B100);
}
