...
byte rows[8] = { 1, 2, 3, 4, 21, 22, 23, 24 };  // {  9, 14, 8, 12, 1, 7, 2, 5};
byte cols[8] = { 5, 6, 7, 8,  9, 10, 11, 12 };  // { 13, 3, 4, 10, 6, 11, 15, 16};

//byte pins[16] = { 5, 4, 3, 2, 14, 15, 16, 17, 13, 12, 11, 10, 9, 8, 7, 6};
byte pins[16] = { 17, 16, 15, 14, 2, 3, 4, 5, 6, 7, 8, 9, 13,12, 11, 10 };
