...
char Keypad::getKey(){
    ...
    pinMode(columnPins[c],OUTPUT);	//activate output
		...
		pinMode(columnPins[c],INPUT);// De-activate the current column.
		digitalWrite(columnPins[c],HIGH);	// setting internal weak pull up.
	}
